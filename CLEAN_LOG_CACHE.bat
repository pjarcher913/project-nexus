...
echo This tool was made to initialize and/or clean the log directory being used by Project Nexus.
echo ===========================================
echo:
echo !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
...
echo ===========================================
echo:
echo Please close the Project Nexus program before using this tool any further.
echo:
